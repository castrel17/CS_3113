...
glm::vec3 g_drops_scale = glm::vec3(-1.5f, -1.5f, -1.5f);  // scale trigger vector
...
void process_input()
{
    ...
    {
        DROPPED = true;
        g_drops_movement.y = -DROPS_SPEED;
    }
    else if(!DROPPED){
        g_drops_movement = glm::vec3(0.0f);
    }
